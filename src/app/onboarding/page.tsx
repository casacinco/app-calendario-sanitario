  ...
  if (done) {
    return (
      <div className="min-h-screen bg-[hsl(var(--bg))] flex items-center justify-center p-4">
        <div className="w-full max-w-sm bg-[#0d2818] border border-[hsl(var(--green))]/30 rounded-xl p-8 text-center space-y-4">
          ...
          <p className="text-sm text-white/60 leading-relaxed">
            ...
            <span className="text-white font-medium">#{done.id}</span>. Em breve
            nossa equipe técnica irá analisar os dados e produzir seu calendário
            sanitário.
          </p>
          <button
            onClick={() => { setDone(null); setF(BLANK); setStep(1); }}
            className="text-sm text-[hsl(var(--green))] underline underline-offset-2"
          >
